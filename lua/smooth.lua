...
function M.get_highlights(style)
	...
	return {
		...
		StatusLine = { fg = colors.fg, bg = colors.visual },
		StatusLineNC = { fg = colors.fg, bg = colors.visual },
		StatusLineTerm = { fg = colors.fg, bg = colors.visual },
		StatusLineTermNC = { fg = colors.fg, bg = colors.visual },
