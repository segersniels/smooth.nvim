...
function M.get_highlights(style)
	...
	return {
		...
		Pmenu = { fg = colors.fg, bg = colors.darkgray },
		PmenuSel = { fg = colors.fg, bg = colors.blue },
		PmenuSbar = { fg = colors.fg, bg = colors.darkgray },
		...
		StatusLine = { fg = colors.fg, bg = colors.darkgray },
		StatusLineNC = { fg = colors.fg, bg = colors.darkgray },
		StatusLineTerm = { fg = colors.fg, bg = colors.darkgray },
		StatusLineTermNC = { fg = colors.fg, bg = colors.darkgray },
		...
		LspInlayHint = { bg = colors.darkgray, fg = colors.gray, italic = true },
		...
		RenderMarkdownCode = { bg = colors.darkgray },
		RenderMarkdownCodeInline = { bg = colors.darkgray },
